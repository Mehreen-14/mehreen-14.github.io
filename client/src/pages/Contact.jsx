...
const EMAIL = "mehreenmaliha14@gmail.com"
// Get your free form endpoint at https://formspree.io
const FORMSPREE_ENDPOINT = "https://formspree.io/f/xbdlrjrj"

const socialLinks = [
  {
    name: "LinkedIn",
    url: "https://www.linkedin.com/in/mehreentabassum14/",
    color: "sky",
    icon: (
  ...
  {
    name: "Facebook",
    url: "https://www.facebook.com/mehreen.tabassum.9041/",
    color: "sky",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
  ...
  {
    name: "Instagram",
    url: "https://www.instagram.com/__mehtab14__/",
    color: "coral",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="social-grid">
            {socialLinks.map((social) => (
              <a
                ...
                className={`social-card social-card--${social.color}`}
              >
                <span className={`social-icon social-icon--${social.color}`}>
                  {social.icon}
                </span>
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <div className="form-footer">
              {/* <p className="form-note">
                ...
                Message will be sent directly to: <strong>{EMAIL}</strong>
              </p> */}
